...
public class PharmacyException extends Exception
{
  ...
  protected PharmacyException(MessageKey paramMessageKey)
  {
  ...
  protected PharmacyException(MessageKey paramMessageKey, Object[] paramArrayOfObject)
  {
    this.key = paramMessageKey;
  ...
  protected PharmacyException(Throwable paramThrowable, MessageKey paramMessageKey)
  {
  ...
  protected PharmacyException(Throwable paramThrowable, MessageKey paramMessageKey, Object[] paramArrayOfObject)
  {
    super(paramThrowable);
    this.key = paramMessageKey;
    this.arguments = paramArrayOfObject;
 ...
 * Qualified Name:     gov.va.med.pharmacy.peps.common.exception.PharmacyException
