...
@XmlType(name="", propOrder={"doseInformation"})
@XmlRootElement(name="drug")
public class Drug extends ValueObject
  implements Serializable
{
  private static final long serialVersionUID = 1L;
  protected DoseInformation doseInformation;
  ...
  public DoseInformation getDoseInformation()
  {
    return this.doseInformation;
  }

  public void setDoseInformation(DoseInformation paramDoseInformation)
  {
    this.doseInformation = paramDoseInformation;
  }

  public boolean isSetDoseInformation()
  {
    return this.doseInformation != null;
  }
 ...
 * Qualified Name:     gov.va.med.pharmacy.peps.external.common.preencapsulation.vo.drug.check.request.Drug
